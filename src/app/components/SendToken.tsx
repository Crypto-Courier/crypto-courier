...
const SendToken = () => {
    ...
    const [tokenAmount, setTokenAmount] = useState('1 ETH');
    ...
    <div className="max-w-4xl mx-auto p-6 bg-gradient-to-br from-red-100 via-pink-100 to-purple-100 rounded-3xl shadow-lg">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="text-right">
          ...
          <div className="text-xl font-bold text-purple-600">$2230.1044</div>
        </div>
      </div>
        ...
        <div className="w-full md:w-1/2">
          ...
          <div className="space-y-2">
            {assets.map((asset, index) => (
              <div key={index} className="flex justify-between items-center bg-white bg-opacity-50 p-2 rounded-xl">
