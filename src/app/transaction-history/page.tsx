    ...
    <div className="main">
      ...
      <div className="txbg ">
        <div className="max-w-3xl mx-auto p-6 bg-gradient-to-br from-red-100 via-pink-100 to-purple-100 rounded-3xl shadow-lg">
          ...
          <button
            className="bg-purple-500 text-white px-4 py-2 rounded-full text-sm mb-6"
            onClick={SendToken}
          >
            GIFT TOKEN
          </button>
          ...
          <div className="space-y-3">
            {transactions.map((tx, index) => (
              <div
                key={index}
                className="flex justify-between items-center bg-white bg-opacity-50 p-3 rounded-xl"
              >
                <div className="flex items-center space-x-3">
